...
# Função para extrair a última UC antes do CNPJ/CPF
def extract_uc(text):
    uc_matches = re.findall(r'UC\s*(\d+)', text)
    return uc_matches[-1] if uc_matches else "Não encontrado"
